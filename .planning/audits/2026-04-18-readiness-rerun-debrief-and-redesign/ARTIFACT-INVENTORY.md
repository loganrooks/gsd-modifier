...
- charter and governing posture: `governance/AUDIT-CHARTER.md`
- authority / artifact-class map for this directory: `governance/WORKSPACE-AUTHORITY-AND-ORGANIZATION.md`
- governance-doc role and update protocol: `governance/GOVERNANCE-READING-AND-UPDATE-PROTOCOL.md`
...
- primary distilled record of session-added framing: `planning-notes/SESSION-FRAMING-BRIEF.md`
- substantive questions and required output shapes: `planning-notes/QUESTION-SET.md`
- corpus split, packeting, and sizing discipline: `governance/EVIDENCE-ARCHITECTURE.md`
- competing audit-program shapes and recommended main path: `planning-notes/PLAN-PROPOSALS.md`

## Active Family Baselines

### Main-Wave And Rerun Program

- main-wave design artifact: `main-wave/MAIN-WAVE-LAUNCH-CONTRACT-AND-PACKET.md`
...
- Wave-1 packet companion: `main-wave/WAVE-1-PACKET-MANIFESTS.md`
...
- `pr-docs-intervention/PR-DOCS-INTERVENTION-CARRY-AUDIT.md`
- `pr-docs-intervention/PR-DOCS-INTERVENTION-TRANSFORMATION-PLAN.md`
...
- `governance/AUDIT-CANON-ABSORPTION-PROTOCOL.md`
- `governance/AUDIT-SUBTREE-AGING-AND-GRADUATION.md`
