...
- [g:r:i] This subtree audits the harness as a current operating machine, not only as a pile of landed intervention slices.
- [d:r:i] Its focus is:
  - where the workspace now stands
  - how findings currently travel across short, medium, and long horizons
  - how deferred / held / seed / doctrine routes are currently handled
