...
1. [PLAIN-LANGUAGE-STATE.md](plain-language/PLAIN-LANGUAGE-STATE.md)
2. [PLAIN-LANGUAGE-GLOSSARY.md](plain-language/PLAIN-LANGUAGE-GLOSSARY.md)
3. [CURRENT-STATE.md](CURRENT-STATE.md)

## Core Read Order

1. [AUDIT-CHARTER.md](governance/AUDIT-CHARTER.md)
2. [WORKSPACE-AUTHORITY-AND-ORGANIZATION.md](governance/WORKSPACE-AUTHORITY-AND-ORGANIZATION.md)
3. [GOVERNANCE-READING-AND-UPDATE-PROTOCOL.md](governance/GOVERNANCE-READING-AND-UPDATE-PROTOCOL.md)
4. [PLAIN-LANGUAGE-STATE.md](plain-language/PLAIN-LANGUAGE-STATE.md)
5. [PLAIN-LANGUAGE-GLOSSARY.md](plain-language/PLAIN-LANGUAGE-GLOSSARY.md)
...
- [intervention-proposals/172-harness-modifier-responsible-closure-first-bundle-field-map.md](intervention-proposals/172-harness-modifier-responsible-closure-first-bundle-field-map.md)
- [intervention-proposals/173-harness-modifier-first-observation-carrier-proposal.md](intervention-proposals/173-harness-modifier-first-observation-carrier-proposal.md)
- [intervention-proposals/174-harness-modifier-first-observe-only-host-exercise-packet-proposal.md](intervention-proposals/174-harness-modifier-first-observe-only-host-exercise-packet-proposal.md)
...
- [responsible-closure-audit/outputs/05-harness-modifier-first-bundle-audit-opus47-max-r1.md](responsible-closure-audit/outputs/05-harness-modifier-first-bundle-audit-opus47-max-r1.md)
- [responsible-closure-audit/dispositions/06-harness-modifier-first-bundle-audit-inheritance.md](responsible-closure-audit/dispositions/06-harness-modifier-first-bundle-audit-inheritance.md)
- [intervention-proposals/175-harness-modifier-observation-carrier-writer-first-slice-implementation.md](intervention-proposals/175-harness-modifier-observation-carrier-writer-first-slice-implementation.md)
- [propagation-audit/62-responsible-closure-observation-carrier-writer-first-slice-change-triggered-refresh.md](propagation-audit/62-responsible-closure-observation-carrier-writer-first-slice-change-triggered-refresh.md)
- [intervention-proposals/176-harness-modifier-host-exercise-packet-contract-first-slice-implementation.md](intervention-proposals/176-harness-modifier-host-exercise-packet-contract-first-slice-implementation.md)
- [propagation-audit/63-responsible-closure-host-exercise-packet-contract-first-slice-change-triggered-refresh.md](propagation-audit/63-responsible-closure-host-exercise-packet-contract-first-slice-change-triggered-refresh.md)
- [responsible-closure-audit/outputs/06-harness-modifier-host-exercise-packet-contract-reread-opus47-max-r1.md](responsible-closure-audit/outputs/06-harness-modifier-host-exercise-packet-contract-reread-opus47-max-r1.md)
- [responsible-closure-audit/dispositions/09-harness-modifier-host-exercise-packet-contract-reread-inheritance.md](responsible-closure-audit/dispositions/09-harness-modifier-host-exercise-packet-contract-reread-inheritance.md)
- [intervention-proposals/177-harness-modifier-release-readiness-extraction-and-audience-split-plan.md](intervention-proposals/177-harness-modifier-release-readiness-extraction-and-audience-split-plan.md)
- [responsible-closure-audit/outputs/07-harness-modifier-release-readiness-and-audience-split-plan-review-gpt54-xhigh-r1.md](responsible-closure-audit/outputs/07-harness-modifier-release-readiness-and-audience-split-plan-review-gpt54-xhigh-r1.md)
- [responsible-closure-audit/dispositions/10-harness-modifier-release-readiness-and-audience-split-plan-review-inheritance.md](responsible-closure-audit/dispositions/10-harness-modifier-release-readiness-and-audience-split-plan-review-inheritance.md)
- [intervention-proposals/178-harness-modifier-first-observe-only-host-exercise-implementation.md](intervention-proposals/178-harness-modifier-first-observe-only-host-exercise-implementation.md)
- [intervention-proposals/179-harness-modifier-shipped-install-contract-classification-pass-proposal.md](intervention-proposals/179-harness-modifier-shipped-install-contract-classification-pass-proposal.md)
- [intervention-proposals/180-harness-modifier-shipped-install-contract-classification-first-slice-implementation.md](intervention-proposals/180-harness-modifier-shipped-install-contract-classification-first-slice-implementation.md)
- [intervention-proposals/181-harness-modifier-route-vs-own-harness-strategy-deferral-note.md](intervention-proposals/181-harness-modifier-route-vs-own-harness-strategy-deferral-note.md)
- [intervention-proposals/182-harness-modifier-first-ci-install-profile-and-extraction-sequencing-proposal.md](intervention-proposals/182-harness-modifier-first-ci-install-profile-and-extraction-sequencing-proposal.md)
- [intervention-proposals/183-harness-modifier-filtered-history-bootstrap-and-onboarding-route.md](intervention-proposals/183-harness-modifier-filtered-history-bootstrap-and-onboarding-route.md)
- [responsible-closure-audit/packets/08-harness-modifier-shipped-install-contract-classification-pass-review-packet.md](responsible-closure-audit/packets/08-harness-modifier-shipped-install-contract-classification-pass-review-packet.md)
- [responsible-closure-audit/specs/08-harness-modifier-shipped-install-contract-classification-pass-review-spec.md](responsible-closure-audit/specs/08-harness-modifier-shipped-install-contract-classification-pass-review-spec.md)
- [responsible-closure-audit/prompts/08-harness-modifier-shipped-install-contract-classification-pass-review-gpt54-xhigh-r1-launch-prompt.md](responsible-closure-audit/prompts/08-harness-modifier-shipped-install-contract-classification-pass-review-gpt54-xhigh-r1-launch-prompt.md)
- [responsible-closure-audit/outputs/08-harness-modifier-shipped-install-contract-classification-pass-review-gpt54-xhigh-r1.md](responsible-closure-audit/outputs/08-harness-modifier-shipped-install-contract-classification-pass-review-gpt54-xhigh-r1.md)
- [responsible-closure-audit/dispositions/11-harness-modifier-shipped-install-contract-classification-pass-review-inheritance.md](responsible-closure-audit/dispositions/11-harness-modifier-shipped-install-contract-classification-pass-review-inheritance.md)
- [propagation-audit/64-responsible-closure-first-observe-only-host-exercise-change-triggered-refresh.md](propagation-audit/64-responsible-closure-first-observe-only-host-exercise-change-triggered-refresh.md)
...
- [WORKSPACE-AUTHORITY-AND-ORGANIZATION.md](governance/WORKSPACE-AUTHORITY-AND-ORGANIZATION.md)
