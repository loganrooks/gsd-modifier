...
- [d:r:i] The first three bounded neutralization slices were completed in the origin repo before extraction; see [../../../docs/migration-origin.md](../../../docs/migration-origin.md) for the carried lineage.
...
- [d:r:i] phase-root and phase-document discovery now route through typed `phase_layout` data
- [d:r:i] state rendering/update now routes through the narrow `state_writer` carrier rather than helper-local edit logic
- [d:r:i] install-contract pointer neutralization still remains explicitly later

## Exact Next Move

- [d:r:i] The extraction lineage through the post-third-neutralization payload-home judgment is carried in [../../../docs/migration-origin.md](../../../docs/migration-origin.md).
- [d:r:i] The next bounded helper move remains install-contract pointer neutralization, not relocation.
- [d:r:i] Keep the held-later artifact-home question explicit rather than silently bundling it into that next move.
