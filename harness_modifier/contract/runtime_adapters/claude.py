...
class ClaudeRuntimeAdapter:
    ...
    def capture_probe_evidence(self, repo_root: pathlib.Path) -> dict[str, Any]:
        return {
            "runtime": self.name,
            "runtime_root": self.runtime_root,
            "probe_family": "claude_probe",
            "note": "Claude parity evidence can be extended with the headless Claude probe when operator-facing proof is required.",
        }
